...
public class Main {
	 ...
	 * 
	 * @return : String que representa a opção escolhida a partir do teclado.
	 */
	...
	/**
	 * Método reponsável por registrar alunos que já responderam questões no quadro.
	 * Caso o aluno já tenha sido registrado ou a matrícula passada não esteja cadastrada no sistema, o 
