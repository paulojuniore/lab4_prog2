...
public class Controle {
	...
	/**
	 * Cadastra um novo grupo. Caso um nome de grupo ja esteja cadastrado, é exibida uma notificação.
	 * 
	 ...
	 * 
	 * @return : retorna a lista de alunos que estão cadastrados em um grupo caso o nome do grupo já esteja cadastrado.
	 */
